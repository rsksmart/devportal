...
- Obtenga información sobre los signatarios y la atestación en la sección de [Atestación del firmware HSM de PowPeg](/concepts/foundations/powpeg/hsm-firmware-attestation).
