...
## PowPegプロトコルの歴史 {#the-history-of-the-powpeg-protocol}
...
Rootstockは、マージマイニングによってBitcoinのハッシュパワーの85%以上で保護されています。そのため、新たなマージマイナーのグループがコンセンサスをハイジャックし、PowHSMに悪意のあるpeg-outを実行させるような状況は、極めて起こりにくいと考えられます。
