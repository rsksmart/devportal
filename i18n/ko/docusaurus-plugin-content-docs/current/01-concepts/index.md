...
| [Rootstock 보안](/concepts/foundations/security/)             | Rootstock 플랫폼은 [Powpeg](/concepts/powpeg/)라는 보안 메커니즘을 사용합니다. 이 메커니즘은 "심층 방어(defence-in-depth)"라는 계층적 보안 모델을 기반으로 합니다.                                           |
