...
const config = {
  ...
  customFields: {
    ...
    newsHighlight : [
      {
        title : '📣 Rootstock Hacktivator is Live! Contribute code or video tutorials and earn rewards. (Note: We\'re not accepting written educational content at this time.)',
