...
<div style={{display: 'flex', justifyContent: 'center', margin: '2rem 0'}}>
  <TrackedLink href="https://rpc.rootstock.io/doc" event="rpcInteractiveApiClick" componentId="interactive-rpc-api-hero-cta" componentLabel="Explore the Rootstock Interactive RPC API" className="btn">
    Explore the Rootstock Interactive RPC API
  </TrackedLink>
</div>

:::info[Info]
The [Rootstock Interactive RPC API](https://rpc.rootstock.io/doc) is available on <Shield label="mainnet" title="testnet" tooltip="Available on Mainnet and Testnet" color="orange" />. To make live requests, you will need an API key. Follow the [Getting Started guide](/developers/rpc-api/rootstock/setup/) to create a free account and generate one.
:::
...
<Steps>
  ...
  <Step title="Get your API key and learn how the Sandbox works">
    ...
    If you don't have an API key yet, follow the **Create an API Key** guide under **Quick Start Guides** to sign up on the [Rootstock RPC dashboard](https://rpc.rootstock.io/) and generate one. You'll paste this key directly into the method page in the next step.

    <div align="center">
      <img width="100%" src="/img/tools/rpc-api-interactive/rpc-interactive-docs-configuration.png" alt="Rootstock Interactive RPC API Sandbox instructions"/>
    </div>
  </Step>
