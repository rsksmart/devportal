...
title: RIF Relay Integration >> transformed/integrate.md
...
tail -n +1 docs/installation-requirements.md > temp_integrate.md
echo --- > transformed/integrate.md
echo sidebar_label: Setup >> transformed/integrate.md
echo sidebar_position: 300 >> transformed/integrate.md
echo title: RIF Relay Installation Requirements
