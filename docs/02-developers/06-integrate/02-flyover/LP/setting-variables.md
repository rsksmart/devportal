...
description: This section lists every environment variable used by the Liquidity Provider Server (LPS), including examples, default values and whether each setting is mandatory.
---
