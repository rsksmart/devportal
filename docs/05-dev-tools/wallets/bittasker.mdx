...
| Rootstock networks | Mainnet (BitTasker app); SDK also supports testnet and regtest |
| BitTasker app platforms | Android (Google Play, Zapstore), Web (iOS coming soon) |

:::info[Roadmap]

BitTasker does not currently support MetaMask, hardware wallets, on-chain Bitcoin, USDT, or rBTC/USDT swaps. These features are on the roadmap. Check the [wallet-core repository](https://github.com/BitTasker/wallet-core) for future releases.
