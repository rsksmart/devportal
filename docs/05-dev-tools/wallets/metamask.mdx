...
description: "Learn the different ways to set up and connect to Rootstock network using a MetaMask Wallet"
---

import WrappedAddNetworkButtons from "/src/components/AddNetworkButtons";

In this guide, you will learn the different ways to set up and connect to Rootstock network using MetaMask.
...
<img class="metamask-screenshot" src="/img/metamask/metamask-1.png" width="800" height="600"></img>

{" "}


<img class="metamask-screenshot" src="/img/metamask/metamask-2.png" width="800" height="600"></img>
...
<img class="metamask-screenshot" src="/img/metamask/metamask-3b.png" width="800" height="600"></img>
