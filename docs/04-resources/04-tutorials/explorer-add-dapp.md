...
![submitBtn](/img/resources/tutorials/dApps/submit-btn.png)

- This opens the Submit dApp form.
![submitForm](/img/resources/tutorials/dApps/submit-form.png)
...
- 4.4 **dApp Logo** (Required)
  ...
  ![logo](/img/resources/tutorials/dApps/logo.png)
...
- 4.5 **Category Selection** (Required).
  ...
  ![category](/img/resources/tutorials/dApps/category.png)

- 4.6 **Project Links**
  - Project URL (Required).
  - X, Discord, GitHub, Telegram (Optional).
  ![links](/img/resources/tutorials/dApps/links.png)

- 4.7 **Support Contact** (Required).
  - Provide a valid support email address.
  - Used for support and internal communication.
  - Not publicly displayed.
  ![contact](/img/resources/tutorials/dApps/contact.png)

## 5. **Submit the dApp Proposal**.
  - After completing the form:
  - Complete the CAPTCHA verification.
  ![captcha](/img/resources/tutorials/dApps/captcha.png)

  - Click **Submit dApp proposal**.
  ![submit-proposal](/img/resources/tutorials/dApps/submit-proposal.png)

  - Your submission is now sent for review.
  ![proposal-sent](/img/resources/tutorials/dApps/proposal-sent.png)
...
After approval:
  ...
  ![approved](/img/resources/tutorials/dApps/approved.png)

  - The dApp card will display all submitted information.
  ![dApp-info](/img/resources/tutorials/dApps/dApp-info.png)
...
- Selecting the token opens the token details view, where the following information is displayed:
  ...
  - Token logo.
  - Project website.
  ![dApp-token](/img/resources/tutorials/dApps/dApp-token.png)
