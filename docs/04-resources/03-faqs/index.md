...
<Accordion>
  ...
  <Accordion.Item eventKey="9">
    ...
    <Accordion.Body>
      ...
      > - **Consensus mechanism:** Rootstock uses merge-mining with Bitcoin, which means that Rootstock blocks are secured by the same miners that secure Bitcoin. Currently, over 85% of Bitcoin's hash power secures Rootstock through merge mining. Liquid uses a federation of trusted functionaries that validate and sign blocks. Rootstock’s merge-mining is more decentralized than Liquid’s federation and provides the thermodynamic security of PoW, which Liquid does not.
...
<Accordion>
  ...
  <Accordion.Item eventKey="4">
    <Accordion.Header as="h3">How can I join RootstockCollective?</Accordion.Header>
    <Accordion.Body>
