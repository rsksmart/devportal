...
![Create Project - Tenderly](/img/kb/BuildWithTenderly/create-project.png)

3 - Import a verified contract or create a project

![Project Title - Tenderly](/img/kb/BuildWithTenderly/project-title.png)

![Add Contract - Tenderly](/img/kb/BuildWithTenderly/add-contract.png)
...
![Add Contract RSK/RIF - Tenderly](/img/kb/BuildWithTenderly/add-contract-rsk-rif-token.png)

5 - Select The `RIFToken` contract and Click Import Contract

![Import RIFToken Contract - Tenderly](/img/kb/BuildWithTenderly/import-verified-rif-contract.png)
...
![Add Contract RSK/RIF - Tenderly](/img/kb/BuildWithTenderly/monitor-rif-token-contracts.png)
