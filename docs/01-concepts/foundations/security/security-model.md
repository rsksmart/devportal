...
The diagram shows how Bitcoin PoW secures Rootstock consensus, how the Bridge commands PowPeg nodes and PowHSMs, and how SSDLC, Coinspect review, bug bounty, and HSM attestation harden those layers.
