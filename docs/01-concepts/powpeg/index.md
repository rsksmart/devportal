...
tags: [rsk, rootstock, rbtc, btc, architecture, powpeg, 2 way peg app]
...
:::note[Info]
- The PowPeg Application is available on [Testnet](https://powpeg.testnet.rootstock.io/) and [Mainnet](https://powpeg.rootstock.io/). 
