...
The federation currently signs as **5-of-9**, expanding toward **20** members. See [PowPeg member updates](/concepts/powpeg/member-updates/) for composition-change phases (vote, delay, migrate).
...
- [Security at Rootstock](/concepts/foundations/security/): why / how / verify overview
- [Security model](/concepts/foundations/security/security-model/): SSDLC, reviews, PowHSM release process
- [Security reports](/concepts/foundations/security/reports/): audit and Coinspect index
- [PowPeg protocol](/concepts/powpeg/): peg-in / peg-out architecture
