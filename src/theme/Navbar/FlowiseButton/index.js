...
export default function FlowiseButton() {
  ...
  return (
    <button
      ...
      onClick={openChat}
      aria-label="Ask Rootstock AI Assistant"
    >
      <span className="ask-rootstock-btn__icon" aria-hidden="true">
        <svg viewBox="0 0 340.13 376.93" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className="ask-rootstock-btn__label">Ask Rootstock</span>
    </button>
  );
}
